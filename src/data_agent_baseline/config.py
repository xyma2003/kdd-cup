...
def load_app_config(config_path: Path) -> AppConfig:
    ...
    agent_config = AgentConfig(
        model=str(os.environ.get("MODEL_NAME") or agent_payload.get("model", agent_defaults.model)),
        api_base=str(os.environ.get("MODEL_API_URL") or agent_payload.get("api_base", agent_defaults.api_base)),
        api_key=str(os.environ.get("MODEL_API_KEY") or agent_payload.get("api_key", agent_defaults.api_key)),
